...
std::vector<DemoConfig> availableDemos = {
    ...
    {"randomwalk", "Random Walker Demo", true, CreateRandomWalkDemo},
    {"perlinwalker", "Perlin Walker Demo", true, CreatePerlinWalkDemo},
    {"ecosystem", "Ecosystem Demo", true, CreateEcosystemDemo}
};
